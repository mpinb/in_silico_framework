...
# assumes you have a network mapper object made with ibs_projects/reduced_model_output_paper/Network
...
def run_recurrent_network(self,
    ...
    self: ReducedModel object from ibs_projects/reduced_model_output_paper/ReducedModel
