...
from .energy_calculations import return_charge_related_calculations_and_ATP
...
def _get_ddf_RW_exploration_template(mdb, key, name, selected_keys, columns = None, inside = True, persist = False, 
    ...
    for k in selected_keys:
        ...
        if augment_new_energy_metrics:
            ...
            out[k] = out[k].assign(**return_charge_related_calculations_and_ATP(out[k]))
...
##The database below contains: 
# 'RW_exploration_2BAC_and_bAP': models ran with only 2BAC and bAP constraints with the models from get_ddf_RW_exploration_new_constraints_no_Att_20231228 as seed points. 
mdb_RW_exploration_2BAC_bAP = I.ModelDataBase('/gpfs/soma_fs/scratch/saka/results/20240528_RW_exploration_2BAC_bAP_with_and_wo_Step')

get_ddf_RW_exploration_2BAC_bAP = I.partial(_get_ddf_RW_exploration_template,
                                                 mdb_RW_exploration_2BAC_bAP, 
                                                 'exploration_2BAC_and_bAP',
                                                 'get_ddf_RW_exploration_2BAC_bAP',
                                                 selected_keys = ['WR64','WR71','88','89','91'])
...
# 'RW_exploration_WR64_increase_depolarization_index': models ran with all constraints (bAP, 2BAC, step, hyperpolarizing, chirp, critical frequency) of WR64, with a condition that the new models need to a higher depolarization index (thus dependent on CaLVA) with the most energy efficient model for WR64 from get_ddf_RW_exploration_new_constraints_no_Att_20231228 as the seedpoint. 
# 'RW_exploration_WR64_from_high_dep_index': exploration started from the models with highest depolarization index (1) from the exploration above. Has the complete PCA space for WR64 as comparable with the models from noAtt_cf_fixed_run1_20231228'

mdb_RW_exploration_WR64_increase_depolarization_index = I.ModelDataBase('/gpfs/soma_fs/scratch/saka/results/20240601_RW_exploration_WR64_increase_depolarization_index')

get_ddf_RW_exploration_WR64_increase_depolarization_index = I.partial(_get_ddf_RW_exploration_template,
                                                 mdb_RW_exploration_WR64_increase_depolarization_index, 
                                                 'RW_exploration_WR64_increase_depolarizaton_index',
                                                 'get_ddf_RW_exploration_WR64_increase_depolarization_index',
                                                 selected_keys = ['WR64'])

get_ddf_RW_exploration_WR64_from_high_dep_index = I.partial(_get_ddf_RW_exploration_template,
                                                 mdb_RW_exploration_WR64_increase_depolarization_index, 
                                                 'RW_exploration_WR64_from_high_dep_index',
                                                 'get_ddf_RW_exploration_WR64_from_high_dep_index',
                                                 selected_keys = ['WR64'])
