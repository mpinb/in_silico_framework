...
#            parentSec = self.sections[currentSec.parentID]
    ...
    def add_synapse(self, secID, ptID, ptx, preId, synapseID):
        if preId not in self.synapses.keys():
            self.synapses[preId] = []
        newSyn = Synapse(secID, ptID, ptx, synapseID)
        newSyn.coordinates = np.array(self.sections[secID].pts[ptID])
        self.synapses[preId].append(newSyn)        
...
class Synapse(object):
    ...
    def __init__(self, edgeID, edgePtID, edgex, synapseID):
        self.secID = edgeID
        self.ptID = edgePtID
        self.x = edgex        
...
class CellParser(object):
    ...
    def __init__(self, hocFilename, NID):
        '''
        Constructor
        '''
        self.hoc_fname = hocFilename
        self.id = NID
        self.spatialgraph_to_cell()
