...
def getSpec_subcellular_features_postsynaptic():
    labels = [
        ...
        "distance_primary_bifurcation",        
        "path_distance_primary_bifurcation",
    ]
    defaults = {
        "length_soma": 0,
        "length_apical": 0,
        ...
        "distance_primary_bifurcation": -1,        
        "path_distance_primary_bifurcation": -1,
    }
    decimalDigits = {
        "length_soma": 6,
        "length_apical": 6,
        ...
        "distance_primary_bifurcation": 6,        
        "path_distance_primary_bifurcation": 6,
    }
    specs = {
        "labels": labels,
        "defaults": defaults,
...
def getSpec_subcellular_features_presynaptic_sparse():
    labels = ["boutons"]
    defaults = {"boutons": 0
    }
    decimalDigits = {
