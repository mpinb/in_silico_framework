...
assert SELECTED_SYNAPSE_MAPPING_METHOD in AVAILABLE_SYNAPSE_MAPPING_METHODS, f"The chosen synapse mapping method {SELECTED_SYNAPSE_MAPPING_METHOD} is not available. Available methods are: {AVAILABLE_SYNAPSE_MAPPING_METHODS}"