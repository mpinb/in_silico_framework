...
#define Gtau1 _p[2]
#define Gtau1_columnindex 2
#define Gtau2 _p[3]
#define Gtau2_columnindex 3
#define Ginc _p[4]
#define Ginc_columnindex 4
#define e _p[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 GSyn /gpfs/soma_fs/scratch/saka/project_src/in_silico_framework/mechanisms/channels_py3_wip/gsyn.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/gpfs/soma_fs/scratch/saka/project_src/in_silico_framework/mechanisms/channels_py3_wip/gsyn.mod";
