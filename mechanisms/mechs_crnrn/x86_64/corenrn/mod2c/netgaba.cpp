...
#define initmodel initmodel__gaba_syn
#define _net_receive _net_receive__gaba_syn
#define _net_init _net_init__gaba_syn
#define nrn_state_launcher nrn_state_gaba_syn_launcher
#define nrn_cur_launcher nrn_cur_gaba_syn_launcher
#define nrn_jacob_launcher nrn_jacob_gaba_syn_launcher 
#if NET_RECEIVE_BUFFERING
#define _net_buf_receive _net_buf_receive_gaba_syn
void _net_buf_receive(NrnThread*);
#endif
 
#define state state_gaba_syn 
...
#define t _nt->_t
#define dt _nt->_dt
#define e _p[0*_STRIDE]
#define risetime _p[1*_STRIDE]
#define decaytime _p[2*_STRIDE]
#define taudgaba _p[3*_STRIDE]
#define decaygaba _p[4*_STRIDE]
#define taufgaba _p[5*_STRIDE]
#define facilgaba _p[6*_STRIDE]
#define i _p[7*_STRIDE]
#define ggaba _p[8*_STRIDE]
#define dgaba _p[9*_STRIDE]
#define fgaba _p[10*_STRIDE]
#define R _p[11*_STRIDE]
#define D _p[12*_STRIDE]
#define factor _p[13*_STRIDE]
#define Ddgaba _p[14*_STRIDE]
#define Dfgaba _p[15*_STRIDE]
#define DR _p[16*_STRIDE]
#define DD _p[17*_STRIDE]
#define _v_unused _p[18*_STRIDE]
#define _g_unused _p[19*_STRIDE]
#define _tsav _p[20*_STRIDE]
...
static void _update_global_variables(NrnThread *_nt, Memb_list *_ml) {
   ...
   _global_variables->dgaba0 = dgaba0;
   _global_variables->fgaba0 = fgaba0;
 ...
 #define dgaba0 static_cast<_global_variables_t*>(_ml->global_variables)->dgaba0
 #define fgaba0 static_cast<_global_variables_t*>(_ml->global_variables)->fgaba0
 
static const char *modelname = "GABAA synapse activated by the network";
...
void _net_buf_receive(NrnThread* _nt) {
  ...
  _nrb->_displ_cnt = 0;
  _nrb->_cnt = 0;
  /*printf("_net_buf_receive__gaba_syn  %d\n", _nt->_id);*/
