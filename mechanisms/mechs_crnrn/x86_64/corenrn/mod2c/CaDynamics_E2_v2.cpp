...
#define initmodel initmodel__CaDynamics_E2_v2
#define _net_receive _net_receive__CaDynamics_E2_v2
#define _net_init _net_init__CaDynamics_E2_v2
#define nrn_state_launcher nrn_state_CaDynamics_E2_v2_launcher
#define nrn_cur_launcher nrn_cur_CaDynamics_E2_v2_launcher
#define nrn_jacob_launcher nrn_jacob_CaDynamics_E2_v2_launcher 
#define states states_CaDynamics_E2_v2 
...
static double FARADAY = /* 0x1.78e555060882cp+16; */ 96485.3321233100141;
...
static void _update_global_variables(NrnThread *_nt, Memb_list *_ml) {
 ...
 #define FARADAY static_cast<_global_variables_t*>(_ml->global_variables)->FARADAY
 ...
 #define cai0 static_cast<_global_variables_t*>(_ml->global_variables)->cai0
