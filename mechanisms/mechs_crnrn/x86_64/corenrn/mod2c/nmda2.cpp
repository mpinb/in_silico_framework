...
#define initmodel initmodel__NMDA_S
#define _net_receive _net_receive__NMDA_S
#define _net_init _net_init__NMDA_S
#define nrn_state_launcher nrn_state_NMDA_S_launcher
#define nrn_cur_launcher nrn_cur_NMDA_S_launcher
#define nrn_jacob_launcher nrn_jacob_NMDA_S_launcher 
#if NET_RECEIVE_BUFFERING
#define _net_buf_receive _net_buf_receive_NMDA_S
void _net_buf_receive(NrnThread*);
#endif
 
#define release release_NMDA_S 
...
#define _gth 0
 static double Alpha_NMDA_S = 0.94;
 static double Beta_NMDA_S = 0.18;
 static double Cdur_NMDA_S = 0.3;
 static double Erev_NMDA_S = 0;
#define Rtau_NMDA_S _thread1data[0]
#define Rtau _thread[_gth]._pval[0]
#define Rinf_NMDA_S _thread1data[1]
#define Rinf _thread[_gth]._pval[1]
 static double mg_NMDA_S = 1;
 static double usetable_NMDA_S = 1;
...
static void _update_global_variables(NrnThread *_nt, Memb_list *_ml) {
   ...
   _global_variables->Alpha = Alpha_NMDA_S;
   _global_variables->Beta = Beta_NMDA_S;
   _global_variables->Cdur = Cdur_NMDA_S;
   _global_variables->Erev = Erev_NMDA_S;
   _global_variables->mg = mg_NMDA_S;
   _global_variables->usetable = usetable_NMDA_S;
...
void _net_buf_receive(NrnThread* _nt) {
  ...
  _nrb->_displ_cnt = 0;
  _nrb->_cnt = 0;
  /*printf("_net_buf_receive__NMDA_S  %d\n", _nt->_id);*/
