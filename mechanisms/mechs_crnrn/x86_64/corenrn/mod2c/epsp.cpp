...
#define initmodel initmodel__epsp
#define _net_receive _net_receive__epsp
#define _net_init _net_init__epsp
#define nrn_state_launcher nrn_state_epsp_launcher
#define nrn_cur_launcher nrn_cur_epsp_launcher
#define nrn_jacob_launcher nrn_jacob_epsp_launcher 
...
#define t _nt->_t
#define dt _nt->_dt
#define onset _p[0*_STRIDE]
#define tau0 _p[1*_STRIDE]
#define tau1 _p[2*_STRIDE]
#define imax _p[3*_STRIDE]
#define i _p[4*_STRIDE]
#define myv _p[5*_STRIDE]
...
#define myexp myexp_epsp
 ...
 inline double curr( _threadargsprotocomma_ double );
 #pragma acc routine seq
 inline double myexp( _threadargsprotocomma_ double );
...
static double _hoc_myexp(void* _vptr) {
 ...
 _r =  myexp ( _threadargs_, *getarg(1) );
 return(_r);
}
