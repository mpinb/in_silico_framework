...
#define initmodel initmodel__SKv3_1_copy
#define _net_receive _net_receive__SKv3_1_copy
#define _net_init _net_init__SKv3_1_copy
#define nrn_state_launcher nrn_state_SKv3_1_copy_launcher
#define nrn_cur_launcher nrn_cur_SKv3_1_copy_launcher
#define nrn_jacob_launcher nrn_jacob_SKv3_1_copy_launcher 
#define rates rates_SKv3_1_copy 
#define states states_SKv3_1_copy 
