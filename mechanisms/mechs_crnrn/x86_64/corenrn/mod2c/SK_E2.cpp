...
static void _update_global_variables(NrnThread *_nt, Memb_list *_ml) {
   ...
   _global_variables->zTau = zTau_SK_E2;
   _global_variables->delta_t = delta_t;
   _global_variables->z0 = z0;
 ...
 #define zTau static_cast<_global_variables_t*>(_ml->global_variables)->zTau
 #define delta_t static_cast<_global_variables_t*>(_ml->global_variables)->delta_t
 #define z0 static_cast<_global_variables_t*>(_ml->global_variables)->z0
