...
#define initmodel initmodel__K2Syn
#define _net_receive _net_receive__K2Syn
#define _net_init _net_init__K2Syn
#define nrn_state_launcher nrn_state_K2Syn_launcher
#define nrn_cur_launcher nrn_cur_K2Syn_launcher
#define nrn_jacob_launcher nrn_jacob_K2Syn_launcher 
#if NET_RECEIVE_BUFFERING
#define _net_buf_receive _net_buf_receive_K2Syn
void _net_buf_receive(NrnThread*);
#endif
 
#define state state_K2Syn 
...
#define _gth 0
#define total_K2Syn _thread1data[0]
...
void _net_buf_receive(NrnThread* _nt) {
  ...
  _nrb->_displ_cnt = 0;
  _nrb->_cnt = 0;
  /*printf("_net_buf_receive__K2Syn  %d\n", _nt->_id);*/
