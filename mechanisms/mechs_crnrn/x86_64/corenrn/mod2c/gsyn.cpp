...
#define initmodel initmodel__GSyn
#define _net_receive _net_receive__GSyn
#define _net_init _net_init__GSyn
#define nrn_state_launcher nrn_state_GSyn_launcher
#define nrn_cur_launcher nrn_cur_GSyn_launcher
#define nrn_jacob_launcher nrn_jacob_GSyn_launcher 
#if NET_RECEIVE_BUFFERING
#define _net_buf_receive _net_buf_receive_GSyn
void _net_buf_receive(NrnThread*);
#endif
 
#define state state_GSyn 
...
#define Gtau1 _p[2*_STRIDE]
#define Gtau2 _p[3*_STRIDE]
#define Ginc _p[4*_STRIDE]
#define e _p[5*_STRIDE]
#define i _p[6*_STRIDE]
#define g _p[7*_STRIDE]
#define A _p[8*_STRIDE]
#define B _p[9*_STRIDE]
#define factor _p[10*_STRIDE]
#define Gfactor _p[11*_STRIDE]
#define DA _p[12*_STRIDE]
#define DB _p[13*_STRIDE]
#define _v_unused _p[14*_STRIDE]
#define _g_unused _p[15*_STRIDE]
#define _tsav _p[16*_STRIDE]
...
#endif
 set_pnt_receive(_mechtype, _net_receive, _net_init, 5);
...
void _net_buf_receive(NrnThread* _nt) {
  ...
  _nrb->_displ_cnt = 0;
  _nrb->_cnt = 0;
  /*printf("_net_buf_receive__GSyn  %d\n", _nt->_id);*/
