...
#define total _thread[_gth].get<double*>()[0]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 K2Syn /gpfs/soma_fs/scratch/saka/project_src/in_silico_framework/mechanisms/channels_py3_wip/k2syn.mod\n");
...
static void _thread_mem_init(Datum* _thread) {
  if (_thread1data_inuse) {_thread[_gth] = (double*)ecalloc(1, sizeof(double));
 }else{
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/gpfs/soma_fs/scratch/saka/project_src/in_silico_framework/mechanisms/channels_py3_wip/k2syn.mod";
