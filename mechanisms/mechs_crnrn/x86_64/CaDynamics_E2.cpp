...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaDynamics_E2 /gpfs/soma_fs/scratch/saka/project_src/in_silico_framework/mechanisms/channels_py3_wip/CaDynamics_E2.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/gpfs/soma_fs/scratch/saka/project_src/in_silico_framework/mechanisms/channels_py3_wip/CaDynamics_E2.mod";
