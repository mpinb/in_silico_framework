...
1. BluePyOpt :cite:`Van_Geit_Gevaert_Chindemi_Roessert_Courcol_Muller_Schuermann_Segev_Markram_2016`, a Multi-Objective Evolutionary Algorithm (MOEA): :mod:`biophysics_fitting.optimizer`.
...
def connected_to_dend_beyond(cell, sec, beyond_dist, n_children_required=2):
    ...
    of the branchpoint reach beyond :param:`beyond_dist`.
...
def get_branching_depth_series(
    ...
    Args:
        cell (:class:`~single_cell_parser.cell.Cell`): The Cell object
        z_offset (int | float, optional): Z coordinate offset for :func:`get_inner_sec_dist_list`.
            Defaults to 706 um.

    Returns:
        pd.Series: contains the distance to :param:`z_offset` as index and a tuple (branching depth, section) as value
