...
"""Convenience methods to fetch biophysical models from a :class:`~data_base.DataBase`
...
def get_model_pdf_from_db(db):
    ...
    Args:
        db (:class:`~data_base.DataBase`): The database containing the models.
...
def get_pdf_selected(
    ...
    See :mod:`~biophysics_fitting.evaluator.Evaluator` for more information
