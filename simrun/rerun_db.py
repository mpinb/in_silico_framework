...
def _evoked_activity(
    ...
    Args:
        ...
        neuron_param_modify_functions (list): List of functions which take :py:class:`~single_cell_parser.parameters.ParameterSet` neuron parameters and may return it changed.
        network_param_modify_functions (list): List of functions which take :py:class:`~single_cell_parser.parameters.ParameterSet` network parameters and may return it changed.
