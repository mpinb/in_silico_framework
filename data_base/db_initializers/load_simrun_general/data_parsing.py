...
def load_dendritic_voltage_traces(
    ...
    to each recsite label in :py:param:`suffix_key_dict`.
...
def _read_n_vtraces(fname):
    ...
    Returns:
        int: Amount of voltage traces in :py:param:`fname`.
    """
...
def _estimate_average_vt_length(fnames, sample_size=1):
    """Estimate the length of all voltage traces in :py:param:`fnames`
    
    Reads the headers of :py:param:`sample_size` random files in :py:param:`fnames` to fetch
    ...
    Args:
        ...
        sample_size (int): Amount of voltage traces headers to read in order to infer their length.
            Set to ``1`` if you expect all votlage trace filenames in :py:param:`fnames` to be of equal length.
